...
(() => {
    ...
    let img = new Image;
    img.src = "https://raw.githubusercontent.com/Coding4hours/Blooket-Cheats/main/autoupdate/timestamps/brawl/killEnemies.png?" + Date.now();
    ...
    img.onload = function() {
        ...
        if (parseInt(time) <= 1693429947197 || iframe.contentWindow.confirm(error)) cheat();
    }
