...
1. Importing one of the Bookmarklets.html files using [these instructions](https://github.com/Coding4hours/Blooket-Cheats/blob/main/tutorial/readme.md)
2. Going to the [GitHub pages site](https://Coding4hours.github.io/Blooket-Cheats), choosing a gamemode, then dragging a cheat to your bookmarks bar or clicking one to copy the script
...
Make sure you're running it properly (see [How to use](https://github.com/Coding4hours/Blooket-Cheats#how-to-use)), if it still doesn't work and other cheats do, then [make an issue](https://github.com/Coding4hours/Blooket-Cheats/issues)
</details>
